...
{
    public partial class VoidReturn : System.Web.UI.Page
    {
        public string msg;
        ...
        protected void txtBarcodeScan_OnTextChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                if (!String.IsNullOrEmpty(txtBarcodeScan.Text) && txtBarcodeScan.Text.Length == 11 && IsDigitsOnly(txtBarcodeScan.Text))
                {
                    ...
                    DataSet ds = blBarcode.GetBarcodeVoidReturn(txtBarcodeScan.Text.Trim());
        ...
        protected void btnSave_ServerClick(object sender, EventArgs e)
        {
            try
            {
                ...
                result = blBarcode.InsertBarcodeVoidReturn(barcode, users.UserName, users.DeptName);
                ...
                if (result)
                {
                    ...
                    {
                        DataSet ds = blBarcode.GetBarcodeVoidReturn(bc);
