<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Layout.Master" AutoEventWireup="true" CodeBehind="VoidTintOneShot.aspx.cs" Inherits="TOAPocket.UI.Web.Barcode.VoidTintOneShot" %>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title">Void Tint One Shot</h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
