<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Layout.Master" AutoEventWireup="true" CodeBehind="VoidReturn.aspx.cs" Inherits="TOAPocket.UI.Web.Barcode.VoidReturn" %>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title">Void รับสินค้าคืน</h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
